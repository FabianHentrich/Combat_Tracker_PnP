...
- **Bilder in Markdown anzeigen**
    - *Warum:* Erhöht die Immersion und Übersichtlichkeit der Monster-Einträge (Visualisierung).
...
- **Initiative-Optionen** (z.B. Re-Roll jede Runde, feste Slots) [Eigener Vorschlag]
    - *Warum:* Erhöht die Flexibilität für verschiedene Regelsysteme.
